...
順帶附上透過 `Interface` org.freedesktop.DBus.Introspectable 的 `Method` Introspect() 得到的資料[JSON 檔案](org.freedesktop.hostname1.json)
### Method Call
...
得到的結果 [JSON 檔案](org.freedesktop.hostname1_2.json) 
### Method Call
