...
- [01. Overview](./Overview.md) - 簡易的說明與術語解釋
- [02. 專案](./Projects.md) - 如何編譯專案與如何增加支援的專案
- [03. 建立新專案](./New_Projects.md) - 如何建立新的專案
...
- [04. 語法-變數類](./Syntax-Variables.md) - 在 Bitbake 中如何處理變數
- [05. 語法-函式類](./Syntax-Functions.md) - 在 Bitbake 中如何處理變數

- [Appendix A. Bitbake 命令參數](./Bitbake_Commands.md) - Bitbake 命令使用的參數
- [Appendix B. 工作管理](./Task-Management.md) - Bitbake 如何管理工作
- [Appendix C. 變數說明](./C_1-Variables.md) - 說明 Bitbake 如何使用變數
    - [Appendix C-1. 變數列表](Variables-Glossary.md) - Bitbake 使用的變數列表，依照名稱排序
